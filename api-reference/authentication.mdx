...
2. **Navigate to API Keys:** Go to the "API Keys" section in the sidebar.
...
<Info>
	The APIs on the staging environment are currently open and do not require an API key for authentication. For testing purposes, you can use the default key `BSK-ONJx5zqEZ8M4RSEF3t1DVFPYQqvU22T54pdfzKm6xixaqVQ74gvTc63YTXmDdf2okVcPd6iSDWJm or Admin-Test(For Currency & Organization API)`. This is subject to change with prior notice, so we recommend using your own API key to prepare for production.
</Info>
...
- **[Currency](/api-reference/customers):** Manage currency-related operations.
- **[Customer](/api-reference/customers):** Create, update, and retrieve customer information.
- **[Organization](/api-reference/Organization):** Manage organizations and their wallets.
...
- **Email:** [support@embedly.com](mailto:support@embedly.com)
- **Community:** Join our [community forum](https://community.embedly.com) to connect with other developers.