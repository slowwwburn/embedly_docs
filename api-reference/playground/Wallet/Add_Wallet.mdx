...
<ParamField body="availableBalance" type="number" required>
  The balance available for transactions.
  **Example:** 23444440
</ParamField>

<ParamField body="ledgerBalance" type="number" required>
  The total balance including pending transactions.
  **Example:** 500000
</ParamField>

<ParamField body="walletRestrictionId" type="string" required>
...
<Expandable title="virtualAccount properties" required>
  ...
  <ParamField body="virtualAccount.bankName" type="string" required>
    The name of the bank for the virtual account.
    **Example:** "Union"
  </ParamField>
</Expandable>

<ParamField body="mobNum" type="string" required>
