...
<ParamField body="customerTypeId" type="string" required></ParamField>

<ParamField body="alias" type="string"></ParamField>

<ParamField body="countryId" type="string" required></ParamField>

<ParamField body="city" type="string" required></ParamField>

<ParamField body="address" type="string" required></ParamField>

<ParamField body="dateCreated" type="string" required></ParamField>
